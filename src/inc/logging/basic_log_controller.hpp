#ifndef __CELESTIALBODIES_LOGGING_BASICLOGGER_HPP__
#define __CELESTIALBODIES_LOGGING_BASICLOGGER_HPP__
...
namespace CelestialBodies::Logging {
...
#endif // __CELESTIALBODIES_LOGGING_BASICLOGGER_HPP__