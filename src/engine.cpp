...
void Engine::draw_stats_overlay(sf::Vector2f position, int text_size )
{
    using namespace Components;
...
void Engine::add_body(
    int planet_radius, 
    int requested_orbit_radius, 
    int requested_start_point,
    sf::Color requested_color
)
{
    using namespace Components;
